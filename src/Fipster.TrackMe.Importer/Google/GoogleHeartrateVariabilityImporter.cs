...
{
    public class GoogleHeartrateVariabilityImporter : IFileClassifier
    {
        public string Type => "google_heartrate_variability";
        public DataSources Source => DataSources.FitbitTakeoutHeartrateVariability;
