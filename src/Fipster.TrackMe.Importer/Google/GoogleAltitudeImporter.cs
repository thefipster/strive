...
{
    public class GoogleAltitudeImporter : IFileClassifier
    {
        public string Type => "google_altitude";
        public DataSources Source => DataSources.FitbitTakeoutAltitude;

        private List<string> Header = new() { "timestamp,gain" };
