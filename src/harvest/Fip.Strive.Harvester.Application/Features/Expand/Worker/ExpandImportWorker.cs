...
namespace Fip.Strive.Harvester.Application.Features.Expand.Worker;

public class ExpandImportWorker(IExpansionService expander) : QueueWorker(SignalTypes.ImportSignal)
{
