...
namespace Fip.Strive.Ingestion.Application.Vendors.Polar.Flow.Training
{
    ...
    public class Exercise
    {
        ...
        public Dictionary<string, double> Cadence { get; set; } = new();

        [JsonPropertyName("heartRate")]
        public ExerciseAltitude? HeartRate { get; set; }

        [JsonPropertyName("power")]
        public Dictionary<string, double> Power { get; set; } = new();

        [JsonPropertyName("speed")]
        public Dictionary<string, double> Speed { get; set; } = new();

        [JsonPropertyName("zones")]
        public Zones? Zones { get; set; }

        [JsonPropertyName("autoLaps")]
        public List<AutoLap> AutoLaps { get; set; } = new();
