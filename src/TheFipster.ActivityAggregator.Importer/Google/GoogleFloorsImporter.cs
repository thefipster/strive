...
{
    public class GoogleFloorsImporter : IFileClassifier
    {
        public string Type => "google_floors";
        public DataSources Source => DataSources.FitbitTakeoutFloors;

        private List<string> Header = new() { "timestamp,floors" };
