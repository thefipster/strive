...
{
    public class GoogleDailyOxygenSaturationImporter : IFileClassifier
    {
        public string Type => "google_daily_oxygen_saturation";
        public DataSources Source => DataSources.FitbitTakeoutDailyOxygenSaturation;
