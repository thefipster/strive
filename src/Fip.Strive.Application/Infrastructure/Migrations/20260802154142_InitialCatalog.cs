...
namespace Fip.Strive.Application.Infrastructure.Migrations
{
    ...
    public partial class InitialCatalog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchiveHash = table.Column<string>(
                        type: "character varying(64)",
                        maxLength: 64,
                        nullable: false
                    ),
                    ...
                    SizeBytes = table.Column<long>(type: "bigint", nullable: false),
                    UploadedUtc = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathInArchive = table.Column<string>(
        ...
        {
            migrationBuilder.DropTable(name: "package_files");

            migrationBuilder.DropTable(name: "catalog_entries");

            migrationBuilder.DropTable(name: "import_packages");
        }
    }
}
