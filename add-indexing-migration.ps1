...
dotnet ef migrations add "$MigrationName" -p .\src\harvest\Fip.Strive.Harvester.Application -s .\src\harvest\Fip.Strive.Harvester.Indexing.Migrator -c IndexContext -o Infrastructure/Indexing/Migrations